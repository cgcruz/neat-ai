...
export default function ThreadItem({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`flex w-full items-center justify-between pr-2 group relative ${isActive ? "bg-[var(--theme-sidebar-thread-selected)] border border-solid border-transparent light:border-white" : "hover:bg-theme-sidebar-subitem-hover"} rounded-[6px]`}
      >
        {thread.deleted ? (
